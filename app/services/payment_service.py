...
class PaymentService:
    ...
    def get_payment_by_provider_ref(self, provider_ref: str) -> Optional[PaymentAttempt]:
    ...
    def update_payment_status(
        ...
        payment = self.db.query(PaymentAttempt).filter(PaymentAttempt.id == payment_id).first()
        if payment:
